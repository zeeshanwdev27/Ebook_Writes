...
function Portfolio({title, description}) {
  ...
  const dummyData = [
    {
      image: "/BookMarketing/Portfolio/img1.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img2.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img3.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img4.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img5.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img6.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img7.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img8.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img9.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img10.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img11.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img12.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img13.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img14.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img15.jpg",
    },
        {
      image: "/BookMarketing/Portfolio/img16.jpg",
    },
  ...
  return (
    <motion.div
      ...
      className="px-3 xs:px-4 sm:px-6 md:px-8 lg:px-40 py-12 sm:py-16 lg:py-20 xl:py-24 bg-white"
    >
      {/* Header Section */}
      <motion.div
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold bg-(--main-color) bg-clip-text text-transparent mb-3 sm:mb-4">
          {title}
        </h1>
