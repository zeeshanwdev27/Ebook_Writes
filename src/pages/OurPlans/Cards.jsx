    ...
    return (
        <div className='w-full min-h-screen flex items-center justify-center py-8 px-4'>
            ...
            >
                ...
                >
                    <motion.h1 
                        className='text-5xl font-bold  mb-4 text-(--main-color)'
                ...
                >
                    {cardData.map((card, index) => (
                        ...
                        >
                            ...
                            <div className='mb-6'>
                                ...
                                >
                                    {card.discountedPrice ? (
                                        <>
                                            <span className='text-2xl font-bold text-(--main-color)'>{card.discountedPrice}</span>
                                            <span className='text-lg text-(--main-color) line-through'>{card.price}</span>
                                        </>
                                    ) : (
                                        <span className='text-2xl font-bold text-(--main-color)'>{card.price}</span>
                                    )}
                                </motion.div>
                            </div>
                            ...
                            <motion.button 
                                className='cursor-pointer w-full bg-(--main-color) text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200'
                           ...
                           <Link to="/contact-us">
                            <motion.button 
                                className='cursor-pointer w-full bg-transparent border text-orange-500 border-(--main-color) font-medium py-3 px-10 rounded-lg transition-colors duration-200'
                                variants={buttonVariants}
                                whileHover="hover"
                                whileTap="tap"
                            >
